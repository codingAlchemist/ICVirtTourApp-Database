...
@interface ARDetailedViewController ()

@end

@implementation ARDetailedViewController

-(void)setCellDataWithName:(NSString*)name andImageName:(NSString*)imageName andText:(NSString*)text
{
    //determine image url
    NSString* urlString = [[NSString alloc]initWithFormat:@"%@/%@.jpg",IMAGEURL,imageName];
    NSURL *url = [NSURL URLWithString:urlString];
    NSURLRequest *requestObj = [NSURLRequest requestWithURL:url];
    
    //make the webview get the image
